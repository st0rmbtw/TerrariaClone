...
use crate::{plugins::{assets::{UiAssets, FontAssets, InventoryItemAssets}, cursor::components::Hoverable, inventory::{Inventory, Slot}, ui::{components::PreviousInteraction, resources::Visible}, audio::{AudioCommandsExt, SoundType}}, language::{keys::{LanguageStringKey, UIStringKey, ItemStringKey}, LocalizedText, args}, common::{extensions::EntityCommandsExtensions, BoolValue, helpers}};
...
pub(super) fn update_slot_size(
    ...
    visibility: Res<Visible<InventoryUi>>,
...
pub(super) fn update_selected_item_name_text(
    inventory: Res<Inventory>,
    inventory_visible: Res<Visible<InventoryUi>>,
